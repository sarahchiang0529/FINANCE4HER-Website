...
const Expenses = () => {
    ...
    return (
        <div className="expenses-container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: '#65318F', color: '#E9D436', minHeight: '100vh', padding: '20px' }}>
            <h1>Expense</h1>
            ...
            <div className="input-container" style={{ width: '100%', maxWidth: '800px', backgroundColor: '#502a6e', borderRadius: '10px', padding: '20px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', marginBottom: '20px' }}>
                <h2 style={{ marginBottom: '20px', color: '#FFFFFF' }}>Add Expense</h2>
                <div className="add-expense" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '10px' }}>
                    <input 
                        type="number" 
                        name="amount" 
                        placeholder="Amount" 
            ...
            <div className="chart-container" style={{ width: '100%', maxWidth: '800px', backgroundColor: '#502a6e', borderRadius: '10px', padding: '20px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', marginBottom: '20px' }}>
                <h2 style={{ marginBottom: '20px', color: '#FFFFFF' }}>Expense Chart</h2>
            ...
            <div className="table-container" style={{ width: '100%', maxWidth: '800px', backgroundColor: '#502a6e', borderRadius: '10px', padding: '20px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
                <h2 style={{ marginBottom: '20px', color: '#FFFFFF' }}>Spending Log</h2>
                <table className="expenses-table" style={{ width: '100%', color: '#E9D436', fontWeight: 'bold', textAlign: 'left', borderCollapse: 'collapse' }}>
                    <thead>
